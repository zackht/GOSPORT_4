...
const Selfbuild = () => {
    ...
    let update = (e) => {
        ...
        Axios.post("http://localhost:3001/selfbuildinfo", data, {
    ...
    // 徽章
    const selectedImages = [{ badgeurl: '/images/yellowstar.svg' }];
    // const [selectedImages, setSelectedImages] = useState([{ badgeurl: '/images/yellowstar.svg' }]);
                    ...
                    <form className='alter_form' onSubmit={update}>
                        <div>
                            ...
                            <div style={{ paddingLeft: "40px" }}>
                                ...
                                <textarea className='alter_textarea' id="account_describe" value={describe} onChange={describeChange} placeholder="請填入一些自我介紹方便其他用戶認識你喔" required="required"></textarea><br />
                            </div>
                        </div>
