    ...
    <div className={`${cc.dd1} container-fluid`}>
        ...
        <div className={cc.ezsurch}>
            <div className={cc.ezsurch1}>
                <button className={cc.tablink} onclick="openCity('London', this, 'white')" id="defaultOpen">租場地</button>
                <button className={cc.tablink} onclick="openCity('Paris', this, 'white')">找零打</button>
                <button className={cc.tablink} onclick="openCity('Tokyo', this, 'white')">找球隊</button>
                <button className={cc.tablink} onclick="openCity('Oslo', this, 'white')">轉租</button>

                <div id="London" className={cc.tabcontent}>
                    <form action="">
                        <div id="local" className={cc.d2}>
                            <p className={cc.d3}>類別</p>
                            <img className={cc.d4} src={ball} alt=""/>
                            <p className={cc.d5}>地區</p>
                            <img style={{marginTop:-17}} className={`${cc.d6}${cc.selectedDate}`} src={arr}/>
                            <img className={`${cc.d7}${cc.selectedDate}`} src={arr}/>
                            <select name="city" className={cc.county}></select>
                            <select name="town" className={cc.district}></select>
                ...
                {/* <div id="Paris" className={cc.tabcontent}>
                    ...
                    </select><img className={`${cc.d59}${cc.selectedDate}`} src={arr}/>
                    <select className={`${cc.d60}${cc.county}`} name="" id="">
                        <option value="">高手</option>
                        <option value="">一般</option>
                        <option value="">新手</option>

                    </select><img className={`${cc.d61}${cc.selectedDate}`} src={arr}/>
                    <button className={cc.serch1}>快速搜尋</button>
                </div>
                <div id="Tokyo" className={cc.tabcontent}>
                ...
                <div id="Oslo" className={cc.tabcontent}>
